...
class SettingsFragment : PreferenceBaseFragment(),
    ...
    private fun refreshRealtimeBridgeSummary() {
        ...
        // Không setSummary() ở đây vì các EditTextPreference/ListPreference có thể đã dùng
        // SummaryProvider từ XML (useSimpleSummaryProvider), nếu setSummary thủ công sẽ crash.
        prefRealtimeOutUrl.isEnabled = enabled

        prefDeviceId?.isEnabled = enabled
        prefPlaybackMode?.isEnabled = enabled
        prefInjectMode?.isEnabled = enabled
    }
