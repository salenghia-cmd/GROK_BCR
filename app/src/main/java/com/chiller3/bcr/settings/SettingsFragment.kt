...
class SettingsFragment : PreferenceBaseFragment(), Preference.OnPreferenceChangeListener,
    ...
    private lateinit var prefDeviceId: EditTextPreference
    private lateinit var prefPlaybackMode: Preference
    private lateinit var prefInjectMode: Preference
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        // === BIND REALTIME BRIDGE PREFS (Pha 1/2) ===
    ...
    private fun refreshRealtimeBridgeSummary() {
        ...
        if (::prefDeviceId.isInitialized) {
            prefDeviceId.summary = prefs.deviceId ?: "android"
        }
        if (::prefPlaybackMode.isInitialized) {
            prefPlaybackMode.summary = prefs.playbackMode
        }
        if (::prefInjectMode.isInitialized) {
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String?) {
        when (key) {
            ...
            Preferences.PREF_OUTPUT_DIR, Preferences.PREF_OUTPUT_RETENTION -> {
                refreshOutputDir()
            }
