...
class SettingsFragment : PreferenceBaseFragment(),
    ...
    private var prefPlaybackMode: ListPreference? = null
    private var prefInjectMode: ListPreference? = null
    ...
    override fun onPreferenceChange(preference: Preference, newValue: Any?): Boolean {
        ...
        when (preference) {
            prefCallRecording -> {
                return if (newValue == false || Permissions.haveRequired(context)) {
                    true
                } else {
